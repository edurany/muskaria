<?php
class Alithemes_Theme_Widget_FeaturePosts extends WP_Widget {
	public function __construct() {
		$id_base = 'alithemes-theme-widget-feature-post';
		$name	= esc_html__('Alithemes Feature Posts', 'livemag');
		$widget_options = array(
					'classname' => 'widget_alith_recent_posts_thumb_widget',
					'description' => esc_html__('Feature Posts display ', 'livemag')
				);
	...
	public function widget( $args, $instance ) {
		...
		if($show_type == 'carausel' ){
			require ALITHEMES_THEME_WIDGET_DIR . '/feature_posts/feature_posts_carausel.php';
		}else if($show_type == 'grid'){
			require ALITHEMES_THEME_WIDGET_DIR . '/feature_posts/feature_posts_grid.php';
		}else if($show_type == 'grid-2'){
			require ALITHEMES_THEME_WIDGET_DIR . '/feature_posts/feature_posts_grid_2.php';
		}
	...
	public function form( $instance ) {
		...
		$options['data'] = array(
				'carausel' 		=> esc_html__('Carausel', 'livemag' ),
				'grid' 		=> esc_html__('Grid full width', 'livemag' ),
				'grid-2' 		=> esc_html__('Grid boxed', 'livemag' ),
		);
